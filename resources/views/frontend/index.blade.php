    ...
    <div class="row">
            ...
            <div class="col-xs-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-2x fa-mars" aria-hidden="true"></i>{{ trans('strings.frontend.subscriptions.essentials') }} ({{trans('strings.frontend.male')}})
                    </div>
        ...
        <a href="{{ route('frontend.package.essentials.female') }}">
            <div class="col-xs-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-2x fa-venus" aria-hidden="true"></i>{{ trans('strings.frontend.subscriptions.essentials') }} ({{trans('strings.frontend.female')}})
                        </div>
